...
if (FREEZE) {
  ...
  // Through the shared writer so the artifact is born in the shape `prettier --check`
  // expects. Written with JSON.stringify alone it failed the format gate the moment it was
  // regenerated, and hand-formatting was undone by the next freeze (#622).
  await writeGeneratedJson(CENSUS_PATH, {
    _readme: [
