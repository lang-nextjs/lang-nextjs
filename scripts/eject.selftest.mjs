...
/*
 * 41, and the arithmetic is the point: two branches each bumped 37 to 39 for a DIFFERENT
 * pair, so taking either side's number would leave the suite running 41 cases against a
 * constant of 39 -- the count guard firing on a tree where nothing is wrong.
 *
 *   37  before both
 *   +2  the repair-fits-the-dirt pair (#1077)
