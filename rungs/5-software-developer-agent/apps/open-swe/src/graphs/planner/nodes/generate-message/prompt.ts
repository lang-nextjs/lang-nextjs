...
<tool_usage>
    ...
    ### Shell tool
        The \`shell\` tool allows to execute shell commands.
        Parameters:
    ...
    ### View file tool
        The \`view\` tool allows to examine the contents of a file or list the contents of a directory. It can read the entire file or a specific range of lines.
        Parameters:
    ...
    ### Scratchpad tool
        The \`scratchpad\` tool allows to write to a scratchpad. This is used for writing down findings, and other context which will be useful for the final review.
        Parameters:
            - \`scratchpad\`: A list of strings containing the text to write to the scratchpad.

    ### Get URL content tool
        The \`get_url_contentq\` tool allows to fetch the contents of a URL. If the total character count of the URL contents exceeds the limit, the \`get_url_content\` tool will return a summarized version of the contents.
        Parameters:
            - \`url\`: The URL to fetch the contents of

    ### Search document for tool
        The \`search_document_for\` tool allows to search for specific content within a document/url contents.
        Parameters:
            - \`url\`: The URL to fetch the contents of
