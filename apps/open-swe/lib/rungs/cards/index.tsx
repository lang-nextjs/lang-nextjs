...
/**
 * Public face of the card registry. `import * as` names no rung, so nothing here can be
 * pruned out from under it. Whatever packs the barrel still exports is what a fork renders.
 */
 ...
 * part type is a real modelling error, and last-write-wins would surface as the wrong card
 * rendering — which reads as a styling bug and gets investigated as one.
 */
 ...
 * broken page — the backend may still emit a part whose card left with its rung.
 */
