 ...
 *
 * THROWS ON COLLISION rather than letting the last pack win. Two rungs claiming the same part
 * type is a real modelling error — a card belongs to the lowest rung that emits its payload,
 * and higher rungs inherit it — but a silent last-write-wins would surface as the wrong card
